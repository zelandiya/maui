...
public final class MauiWrapper {
    ...
    public static void main(String[] args) {
        ...
        String modelName = "best_sremoval_filtered2";
        String dataDirectory = currentDir + "/";
        String filePath = currentDir + "/data/term_assignment/test/w7540e.txt";
		...
		try {
			...
			log.error("Problem while loading and initializing vocabulary and model" + e);
        ...
        try {
        	...
        	log.error("Problem while loading MauiWrapper:\n" + e);
        	throw new RuntimeException();
